...
SHARED_DIR=$(echo $PWD|sed 's/dockerfiles/alert_manager/')
printf "  volumes:\n" >> fig.yml
printf "    - $SHARED_DIR:/srv/www/alert_manager\n" >> fig.yml 
...
printf "\033[1mIt should be something like $SHARED_DIR:/srv/www/alert_manager\033[m\n"
